                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="" name="course_code" id="course_code" class="form-control"
                                placeholder="Masukkan Kode Mata Pelajaran" required="" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label>Nama Mata Pelajaran</label>
                            <input type="" name="course_name" id="course_name" class="form-control"
                                placeholder="Masukkan Nama Mata Pelajaran" required="" autocomplete="off">
                        </div>
                    </div>
                </div>
...
<div class="modal fade myModal" id="updateCourse" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog " role="document">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="course_id">
                                @if (isset($course))
                                    <option value="0">- Pilih Ujian/Tes - </option>
                                    @foreach ($course as $c)
                                        <option value="{{ $c->id }}">{{ $c->course_code }} -
                        ...
                        <div class="form-group">
                            ...
                            <input type="" name="title" class="form-control" placeholder="Masukkan Nama Ujian/Test"
                                required="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" rows="4"
                                placeholder="Masukkan Deskripsi Ujian/Tes" required=""></textarea>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="bdate" id="bdate" class="form-control"
                                placeholder="Input Birhdate" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label>Gender</label>
                    ...
                    <div class="col-md-12">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="" name="opt_1" id="choice_A" class="form-control"
                                    placeholder="Masukkan Jawaban A" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Jawaban B</label>
                                <input type="" name="opt_2" id="choice_B" class="form-control"
                                    placeholder="Masukkan Jawaban B" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Jawaban C</label>
                                <input type="" name="opt_3" id="choice_C" class="form-control"
                                    placeholder="Masukkan Jawaban C" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Jawaban D</label>
                                <input type="" name="opt_4" id="choice_D" class="form-control"
                                    placeholder="Masukkan Jawaban D" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label>Jawaban Yang Benar</label>
                                <input type="" name="correctAnswer" id="correct_answer" class="form-control"
                                    placeholder="Masukkan Jawaban Yang Benar" autocomplete="off">
                            </div>
                        </fieldset>
                    </div>
                </div>
...
<div class="modal fade" id="modalForAddAnnouncement" tabindex="-1" role="dialog"
...
<div class="modal fade" id="modalForAddTestimoni" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document" style="">

        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Testimoni <br></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form class="refreshFrm" method="post" id="addTestimoniFrm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Lususan</label>
                                <input type="text" name="lulusan" id="lulusan" class="form-control" placeholder=""
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" name="testimoni" id="testimoni" class="form-control"
                                    autocomplete="off"></textarea>
                            </div>
                        </div>
                    </div>
