...
<div class="row">
    <div class="container emp-profile">
            ...
            <div class="form-group container">
                ...
                <a href="{{route('confirm.id', ['id' => $register->id])}}" class="btn btn-success">Confirm</a>
                <a href="{{route('download.formulir', ['param'=>$register->no_induk_siswa_nasional])}}" class="btn btn-primary ml-1">
                    Cetak Formulir
                </a>
                @else
                <a href="{{route('download.formulir', ['param'=>$register->no_induk_siswa_nasional])}}" class="btn btn-primary ml-1">
                ...
                <a href="{{route('download', ['filename' => 'bukti-daftar.doc'])}}" class="btn btn-info ml-1">
