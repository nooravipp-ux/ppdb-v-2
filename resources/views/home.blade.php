    ...
    <div class="col-md-12 col-xl-12">
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                PPDB Online ini bertujuan untuk membantu calon Peserta Didik agar lebih mudah dalam mendaftar dan melihat hasil seleksi peneirmaan peserta didik baru di SMK Widya Dirgantara. <br> <br>
                Jika anda sudah melakukan login, berarti anda wajib mengikuti ujian seleksi dengan waktu yang telah ditentukan.
            </p>  
                <hr>
            </div>
        </div>
