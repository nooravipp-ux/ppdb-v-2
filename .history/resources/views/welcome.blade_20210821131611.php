    ...
    <main id="main">
        ...
        <section id="jurusan" class="skills services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch card border-0" data-aos="zoom-in" data-aos-delay="100">
                        <div class="icon-box">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0 card border-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0 card border-0" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box">
                    ...
                    <div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0 card border-0" data-aos="zoom-in" data-aos-delay="400">
                        <div class="icon-box">
