...
<div class="row mb-lg-5 ">
    ...
    <div class="col-md-5 col-xl-5">
        <div class="card">
            <img src="{{asset('landing-page/assets/img/alur2.png')}}" class=" container img-fluid p-2 rounded" alt=""> <br> <br>
            <div class="text-center">
                <a href="" class=" btn btn-info mb-5 ">Download <span>Syarat & Panduan Pendaftaran</span></a>
            </div>
        </div>
    </div>
</div>
