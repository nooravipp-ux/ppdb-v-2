...
<head>
                    ...
                    <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                        ...
                        <div class="accordion-list">
                            <ul>
                                ...
                                <li>
                                    <a data-bs-toggle="collapse" data-bs-target="#accordion-list-6" class="collapse"><span>06</span> Ujian/Tes online<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
                                    <div id="accordion-list-6" class="collapse" data-bs-parent=".accordion-list">
                                        <p>
                                            Calon Peserta Didik Baru diwajibkan mengikuti  Ujian/Tes Potensi Akademik (TPA) yang dilaksanakan secara online. Tes ini berupa soal pilihan ganda yang bisa dikerjakan dimanapun dan kapanpun.
                                        </p>
                                    </div>
                                </li>
    ...
    <footer id="footer">
        ...
        <div class="footer-top section-bg" id="kontak">
            <div class="container">
                <div class="row">
