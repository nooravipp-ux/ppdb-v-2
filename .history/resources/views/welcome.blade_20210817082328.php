                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <div class="social-links">
                            <a href="#" class="facebook"><i class=" fa fa-address-card"></i></a> SMK Widya Dirgantara
                            <a href="#" class="instagram"><i class="bx bxl-instagram"></i></a> smkwidyadirgantara_official
                            <a href="#" class="youtube"><i class="bx bxl-youtube"></i></a> SMK Widya Dirgantara
                            <a href="#" class="dribbble"><i class="bx bxl-dribbble"></i></a> widyadirgantara.sch.id
                        </div>
                    </div>
                </div>
