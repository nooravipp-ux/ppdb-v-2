        ...
        <div class="footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        <h4>Sosial Media</h4>
                        <p>Jangan lupa Follow dan juga Subscribe keaktifan kami di social media</p>
                        <div class="social-links mt-3">
                            <a href="#" class="facebook"><span><p>SMK Widya Dirgantara</p></span><i class="bx bxl-facebook"></i></a>
