            ...
            <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                ...
                <tr>
                    <td style="padding: 20px;">
                        <button type="button" class="btn btn-warning p-3 pl-4 pr-4" id="resetExamFrm">Reset</button>
                        <input name="submit" type="submit" value="Submit" class="btn btn-primary p-3 pl-4 pr-4 float-right" id="submitAnswerFrmBtn">
                    </td>
                </tr>
