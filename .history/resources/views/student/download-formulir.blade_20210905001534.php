...
<body>
    <img src="{{ url('/images/image.png') }}" style="width: 100px; height:100px">
    <p>{{ public_path ('ding-page/assets/img/kopwd2.lanjpg') }} Formulir Pendaftaran Siswa Baru <br class="mt-2"> Tahun Pelajaran 2020-2021</p>
    <div class="container">
        {{-- Data Saya --}}
