...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    <div class="container-fluid">
        <form id="form-register" role="form" class="wizard fa-wizards-of-the-coast sf-nav-on-top" method="get" action="/student-registration/save">
            <div class="alert alert-primary sf-viw">
