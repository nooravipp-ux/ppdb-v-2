        ...
        <form id="form-register" role="form" method="get" action="/student-registration/save">
            ...
            <div class="row d-flex flex-column align-content-center">
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Provinsi:</label>
                        <input type="text" name="provinsi_ortu" class="form-control" placeholder="provinsi_ortu">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Kabupaten:</label>
                        <input type="text" name="kabupaten_ortu" class="form-control" placeholder="kabupaten_ortu">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Kecamatan:</label>
                        <input type="text" name="kecamatan_ortu" class="form-control" placeholder="kecamatan_ortu">
                    </div>
                </div>
            </div>
            <div class="row d-flex flex-column align-content-center">
            ...
            <div class="row d-flex flex-column align-content-center">
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Provinsi:</label>
                        <input type="text" name="provinsi_wali" class="form-control" placeholder="provinsi_wali">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Kabupaten:</label>
                        <input type="text" name="kabupaten_wali" class="form-control" placeholder="kabupaten_wali">
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
                        <label>Kecamatan:</label>
                        <input type="text" name="kecamatan_wali" class="form-control" placeholder="kecamatan_wali">
                    </div>
                </div>
            </div>
            <div class="row d-flex flex-column align-content-center">
