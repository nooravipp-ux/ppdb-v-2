    ...
    <div class="col-md-12 col-xl-12">
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center container" style="font-size: 17px;">Selamat Datang di website sistem informasi Penerimaan Peserta Didik Baru (PPDB) SMK Widya Dirgantara. <br>
                PPDB Online ini bertujuan untuk membantu calon Peserta Didik agar lebih mudah dalam mendaftar dan melihat hasil seleksi peneirmaan peserta didik baru di SMK Widya Dirgantara.</p>  
                <hr>
                <p>Jika anda sudah masuk ke dashboard ini, berarti anda sudah mendaftar ke SMK Widya Dirgantara.</p>
                <br>
                 <p>
                     Jangan lupa untuk mengikuti ujian seleksi karena ini bersifat wajib bagi semua calon Peserta Didik.
                 </p>   
            </div>
        </div>
    </div>
...
<div class="row mb-lg-5 ">
    <div class="col-md-7 col-xl-7">
        ...
        <div class="card mb-2">
            <h1 class="card-header" style="font-size: 25px;">INFORMASI</h1>
            <div class="card-body">
