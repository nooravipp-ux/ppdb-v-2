            ...
            <div class="container" data-aos="zoom-in">
                ...
                <div class="row">
                    <div class="col-lg-9 text-center text-lg-start">
                        <h3>Testimoni Alumin</h3>
                        <p> Berawal dari Sekolah SMK Muhammadiyah loa kulu banyak pelajaran yang saya dapatkan tentang kesidiplinan, ilmu agama dan banyak lagi, kompetensi keahlian administrasi perkantoran yang mengajarkan siswa siswinya untuk teliti dalam hal apapun terutama dalam mengolah laporan dan arsip arsip yang ada .</p>
                    </div>
        ...
        <section id="galeri" class="portfolio">
            <div class="container" data-aos="fade-up">
                ...
                <ul id="portfolio-flters" class="d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <li data-filter=".filter-card">TKJ</li>
                    <li data-filter=".filter-web">TBSM</li>
                </ul>

                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">

                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{asset('landing-page/assets/img/portfolio/sekolah1.jpg')}}" class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{asset('landing-page/assets/img/portfolio/sekolah2.jpg')}}" class="img-fluid" alt=""></div>
                        <div class="portfolio-info">
                            <h4>App 2</h4>
                            <p>App</p>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-img"><img src="{{asset('landing-page/assets/img/portfolio/sekolah3.jpg')}}" class="img-fluid" alt=""></div>
                        <div class="portfolio-info">
                            <h4>App 3</h4>
                            <p>App</p>
