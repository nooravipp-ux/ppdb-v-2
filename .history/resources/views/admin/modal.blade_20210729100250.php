        ...
        <form class="refreshFrm" id="addCourseFrm" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Tes</h5>
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="" name="course_code" id="course_code" class="form-control" placeholder="Input Course Code" required="" autocomplete="off">
                        </div>
                        <div class="form-group">
                            <label>Course</label>
                            <input type="" name="course_name" id="course_name" class="form-control" placeholder="Input Course Name" required="" autocomplete="off">
                        </div>
                    </div>
                </div>
