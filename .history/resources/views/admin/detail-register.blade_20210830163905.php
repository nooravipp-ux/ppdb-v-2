    ...
    <div class="container emp-profile">
        <form>
            ...
            <div class="form-group row container">
                <div class="card col-sm-3 container card shadow p-2 rounded">
                    @if($register->status == 0)
                        <a href="{{route('confirm.id', ['id' => $register->id])}}" class=" col-sm-4 btn btn-success btn-sm">Confirm</a> <br>
                        @endif
                        {{-- <a href="{{route('confirm.id', ['id' => $register->id])}}" class="btn btn-success btn-sm">Confirm</a> --}}
                    <button type="button" class=" col-sm-4 btn btn-secondary ml-1">
            ...
            <div class="form-group row container">
                <div class="card col-sm-9 container card shadow p-2 rounded">
                    ...
                    <div class=" container card shadow p-2 rounded">
                        ...
                        <div class="card-body p-3 container">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="{{$register->pilihan_jurusan}}">
                                </div>
                            </div>
                            <div class="form-group row">
