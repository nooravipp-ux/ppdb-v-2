...
<div class="row">
    <div class="container emp-profile">
            ...
            <div class="form-group container">
                ...
                <a href="{{route('download.formulir', ['param'=>$register->no_induk_siswa_nasional])}}" type=" button" class="btn btn-info ml-1">
                    Cetak Formulir
                </a>
                @else
                <a href="{{route('download.formulir', ['param'=>$register->no_induk_siswa_nasional])}}" type=" button" class="btn btn-info ml-1">
                ...
                <a href="{{route('download', ['filename' => 'bukti-daftar.doc'])}}" class="btn btn-success ml-1">
