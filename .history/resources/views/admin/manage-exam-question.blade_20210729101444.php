...
<div class="app-page-title">
    <div class="page-title-wrapper">
        <div class="page-title-heading">
            ...
            <div>Kelola Pilihan Ganda Ujian
                <div class="page-title-subheading">Tambah Pertanyaan
                </div>
            </div>
        </div>
    </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a rel="facebox" href="facebox_modal/updateQuestion.php?id=" class="btn btn-sm btn-primary">Update</a>
                                                        <button type="button" id="deleteQuestion" data-id='' class="btn btn-danger btn-sm">Delete</button>
                                                    </td>
                                                </tr>
                                                @endforeach
                                                @else
