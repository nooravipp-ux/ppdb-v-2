                    ...
                    <nav id="navbar" class="navbar navbar-expand-lg">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class=" navbar-nav mr-auto">
                                ...
                                <li class=" nav-item"><a class="nav-link scrollto" href="#informasi">Informasi</a></li>
                                <li class=" nav-item"><a class="nav-link scrollto" href="#jurusan">Jurusan</a></li>
                                <li class=" nav-item"><a class="nav-link scrollto" href="#galeri">Galeri</a></li>
                                <li class=" nav-item"><a class="nav-link scrollto" href="#kontak">Kontak</a></li>
                                <li class=" nav-item"> <button class="btn ">
                                        <a class="nav-link scrollto" href="{{url('/login')}}">Login</a></li>
                                    </button>
                            </ul>
                        </div>
