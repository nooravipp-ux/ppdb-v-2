    ...
    <div class="col-md-12 col-xl-12">
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                <hr>
                <p>Jika anda sudah masuk ke dashboard ini, berarti anda sudah mendaftar ke SMK Widya Dirgantara.Jangan lupa untuk mengikuti ujian seleksi karena ini bersifat wajib.</p> 
            </div>
        </div>
    </div>
</div>
