        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start"> <hr>
                        <a href="{{url('/')}}" class=" btn btn-warning btn-get-started scrollto">Kembali</a>
                        <a href="{{url('/')}}" class="btn-get-started scrollto"><span>Download / Print Out Formulir</span></a>
                    </div> 
                </div>
