    ...
    <div class="col-md-12 col-xl-12">
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center container" style="font-size: 19px;">Selamat Datang di website sistem informasi Penerimaan Peserta Didik Baru (PPDB) SMK Widya Dirgantara. <br>Adanya PPDB yang bersifat Online ini bertujuan untuk membantu calon Peserta Didik agar lebih mudah dalam mendaftar dan melihat hasil seleksi peneirmaan peserta didik baru di SMK Widya Dirgantara.</p>   
            </div>
        </div>
    </div>
</div>
...
<div class="row mb-lg-5">
    ...
    <div class="col-md-5 col-xl-5">
        <img src="{{asset('landing-page/assets/img/alur2.png')}}" class=" container img-fluid animated shadow p-2 rounded" alt="">
    </div>
</div>
@endif
