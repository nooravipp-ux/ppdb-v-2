    ...
    <div class="col-md-12 col-xl-12">
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                <p class="card-text text-center" style="font-size: 20px;">Selamat Datang di website sistem informasi Penerimaan Peserta Didik Baru (PPDB) Online SMK Widya Dirgantara </p>
