...
<body>
        ...
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                ...
                <div class="header__pane ml-auto">
                    <div>
                        <button type="button" class=" ml-3 hamburger close-sidebar-btn" data-class="closed-sidebar">
            ...
            <div class="app-header__mobile-menu">
                <div>
                    <button type="button" class=" ml-3 hamburger mobile-toggle-nav">
                        <span class="hamburger-box">
                            <span class="hamburger-inner"></span>
                        </span>
                    </button>
                                    ...
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="" alt="">
                                             <i class=" fa fa-user"></i> a <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            {{-- <li>
                                <a href="{{url('/print-formulir')}}">
                                    <i class="metismenu-icon pe-7s-volume"></i>
                                    Cetak Formulir
                                </a>
                            </li>
                            <li>
                                <a href="{{url('/print-register')}}">
                                    <i class="metismenu-icon pe-7s-volume"></i>
    ...
    <script src="{{asset('admin-panel/js/datatables/js/jquery.dataTables.min.js')}}"></script>
    <script src="{{asset('admin-panel/js/datatables/js/dataTables.bootstrap4.min.js')}}"></script>
