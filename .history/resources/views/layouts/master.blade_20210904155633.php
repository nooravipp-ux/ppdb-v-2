...
<head>
	...
	<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script> --}}
        ...
        <!-- summernote -->
        <link rel="stylesheet" href="{{ asset ('admin-panel/assets/plugins/summernote/summernote-bs4.min.css')}}">
...
<body class=" hold-transition sidebar-mini layout-fixed">
    {{-- <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{ asset ('admin-panel/assets/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
        </div>
    </div> --}}
    <nav class="main-header navbar navbar-expand navwh">
