        ...
        <section id="jurusan" class="skills services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-xl-3 col-md-6 card border-0" data-aos="zoom-in" data-aos-delay="200">
                        <div class="icon-box">
                    ...
                    <div class="col-xl-3 col-md-6 card border-0" data-aos="zoom-in" data-aos-delay="300">
                        <div class="icon-box">
                    ...
                    <div class="col-xl-3 col-md-6 card border-0" data-aos="zoom-in" data-aos-delay="400">
                        <div class="icon-box">
