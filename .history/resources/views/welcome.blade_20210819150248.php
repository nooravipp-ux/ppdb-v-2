                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                ...
                                <p class=" d-block w-100" alt="First slide"> Berawal dari Sekolah SMK Widya Dirgantara banyak pelajaran yang saya dapatkan tentang kesidiplinan, karakter dan masih banyak lagi, kompetensi keahlian Teknik Bisnis dan Sepeda Motor mengajarkan siswa - siswinya untuk teliti dalam hal apapun terutama dalam memperbaiki sepeda motor.</p>
                                
                            </div>
                            <div class="carousel-item">
                                {{-- <img class="d-block w-100" src=".../800x400?auto=yes&bg=666&fg=444&text=Second slide" alt="Second slide"> --}}
                                <p class=" d-block w-100" alt="Second slide"> Berawal dari Sekolah SMK Widya Dirgantara banyak pelajaran yang saya dapatkan tentang kesidiplinan, karakter dan masih banyak lagi, kompetensi keahlian Teknik Bisnis dan Sepeda Motor mengajarkan siswa - siswinya untuk teliti dalam hal apapun terutama dalam memperbaiki sepeda motor.</p>
                              </div>
                              <div class="carousel-item">
