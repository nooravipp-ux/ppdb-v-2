        ...
        <section id="why-us" class="why-us section-bg">
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 img" data-aos="zoom-out" data-aos-delay="100">
                    <img src="{{asset('landing-page/assets/img/ppdb_online.png')}}" class="img-fluid img-thumbnail animated" alt="">
                    </div>
                </div>
