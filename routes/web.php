...
//     return view('welcome');
// });
Route::get('/', [App\Http\Controllers\HomeLandingController::class, 'index'])->name('/');
...
Route::post('/testimoni/add-testimoni', [App\Http\Controllers\TestimoniController::class, 'add'])->name('add-testimoni');
Route::post('/testimoni/delete-testimoni', [App\Http\Controllers\TestimoniController::class, 'deleteTestimoni'])->name('delete-testimoni');
Route::get('/landing-testimoni', [App\Http\Controllers\TestimoniController::class, 'landingPage'])->name('landing-testimoni');
